...
func (app *application) readUUIDParam(r *http.Request) (uuid.UUID, error) {
	...
	if err != nil {
		return uuid, fmt.Errorf("invalid uuid %v: %w", uuidParam, err)
	}

	return uuid, nil
}

// writeJSON writes the given data envelope as JSON to the response body, optionally with
// additional headers.
...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst any) error {
	...
	if err != nil {
		...
		// Occurs when something that is not a non-nil pointer is passed to Decode()
